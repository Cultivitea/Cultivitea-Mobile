    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Image(
                ...
                modifier = Modifier.requiredSize(200.dp).padding(top = 64.dp, bottom = 30.dp)
            )
            ...
            Column(modifier = Modifier.padding(16.dp), horizontalAlignment = Alignment.Start) {
                ...
                TextField(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .border(1.dp, if (usernameError != null) Color.Red else PrimaryBrown, RoundedCornerShape(20.dp)),
